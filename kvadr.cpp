...
int main()
{
    ...
    int rozhodnuti, pokracovani, fail; //rozhodujici
    do
    {
        ...
        else if (pokracovani == 2)
        {
            break;
        }
        else
        {
            printf("Zadal jsi hodnotu mimo.\n");
            printf("Chcete to zkusit znova?: [1 - ANO, 2 - NE]: ");
            scanf("%d", &fail);
            if (fail == 1)
            {
                printf("Zadej to znova: ");
                scanf("%d", &pokracovani);
            }
            else if (fail == 2)
            {
